...
namespace SampleWPFApplication.ViewModel
{
    class UserViewModel
    {
        ...
        public IList<User> Users { get { return _UserList; } set { _UserList = value; } }
        private ICommand mUpdater;
        public ICommand UpdateCommand { get { if (mUpdater == null) mUpdater = new Updater(); return mUpdater; } set { mUpdater = value; } }
    }
